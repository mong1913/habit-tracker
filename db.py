...
def insert_myhabit(db, habit_name, description, frequency, start_date, current_streak, max_streak):
    with get_cursor(db) as cur:
        cur.execute('''
                    INSERT INTO myhabit (habit_name, description, frequency, 
                                            start_date, current_streak, max_streak)
                    VALUES (?, ?, ?, ?, ?, ?)
                    ''', (habit_name.title(), description, frequency, start_date, current_streak, max_streak))
